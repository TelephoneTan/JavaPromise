...
public class TestCancellableVersionedTask {
    ...
    void test1() {
        VersionedTask<Object> t = new VersionedTask<>((resolver, rejector, cancelledBroadcast) -> {
    ...
    void test2() {
        VersionedTask<Object> p = new VersionedTask<>((resolver, rejector, cancelledBroadcast) -> {
